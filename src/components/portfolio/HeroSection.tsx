  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center">
      ...
      >
        ...
        >
          {[
            { href: "https://github.com/elite-kyle", icon: "simple-icons:github", label: "GitHub", color: "hover:text-gray-900 dark:hover:text-white" },
            { href: "https://www.linkedin.com/in/kyle-larsen-8544a9402", icon: "skill-icons:linkedin", label: "LinkedIn", color: "hover:text-blue-600" },
            { href: "mailto:elite.kyle@outlook.com", icon: "material-icon-theme:email", label: "Email", color: "hover:text-green-600" }
          ].map((link) => (
